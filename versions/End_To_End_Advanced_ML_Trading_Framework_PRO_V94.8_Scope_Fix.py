# End_To_End_Advanced_ML_Trading_Framework_PRO_V94.8_Scope_Fix
#
# V94.8 Update:
# 1. BUG FIX: Resolved a fatal UnboundLocalError in the Optuna objective
#    function by correcting the order of operations. Data is now scaled
#    *before* being referenced in the model's fit parameters.
#
# V94.7 Update:
# 1. BUG FIX: Resolved a TypeError in the Optuna optimization loop.
#
# V94.6 Update:
# 1. CONFIG FIX: Updated the GeminiAnalyzer to use the `gemini-2.0-flash` endpoint.
...
# =============================================================================
# 7. BACKTESTER & 8. PERFORMANCE ANALYZER (No changes needed)
# =============================================================================
class Backtester:
    # ... (code is unchanged)
    def __init__(self,config:ConfigModel):self.config=config
...
def main():
    ...
    current_config={
        "BASE_PATH": os.getcwd(), "REPORT_LABEL": "ML_Framework_V94_Scope_Fix",
...
# End_To_End_Advanced_ML_Trading_Framework_PRO_V94.8_Scope_Fix.py
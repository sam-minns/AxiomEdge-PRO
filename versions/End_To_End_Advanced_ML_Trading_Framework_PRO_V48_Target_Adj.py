# End_To_End_Advanced_ML_Trading_Framework_PRO_V48_Target_Adj
#
# V48 Update:
# 1. Adjusted the triple-barrier labeling to target a smaller take profit (tp_atr=2.5).
#    This is designed to increase the number of trades and potentially the win rate by
#    focusing on more frequent, shorter-term price moves.
...
raw_config = {
    ...
    "REPORT_LABEL": "ML_Framework_V48_Target_Adj",
...
def main():
    ...
    for i, period_start_date in enumerate(retraining_dates):
        ...
        # The only change is here: tp_atr=2.5
        df_train_labeled = fe.label_outcomes(df_train_raw, sl_atr=1.5, tp_atr=2.5, lookahead=config.LOOKAHEAD_CANDLES)
...
# End_To_End_Advanced_ML_Trading_Framework_PRO_V48_Target_Adj.py
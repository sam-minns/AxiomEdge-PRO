...
class GeminiAnalyzer:
    def __init__(self):
        ...
        api_key = "AIzaSyAxoYnuzd4d5EbjeKS8bJoXtq_0AW-WVdM"
        # -----------------------------
    ...
    def analyze_cycle_and_suggest_changes(self, cycle_results: Dict) -> Dict:
        ...
        prompt = (
            "You are an expert trading model analyst. Given the following walk-forward trading cycle results, suggest new integer values for 'LOOKAHEAD_CANDLES' "
...
class ConfigModel(BaseModel):
    BASE_PATH: DirectoryPath; DATA_FILENAMES: List[str]; REPORT_LABEL: str; FORWARD_TEST_START_DATE: str; INITIAL_CAPITAL: confloat(gt=0)
...
# End_To_End_Advanced_ML_Trading_Framework_PRO_V86_Direct_API_Key.py
# End_To_End_Advanced_ML_Trading_Framework_PRO_V115_Playbook_Timing_FIX
#
...
#
# V114 UPDATE (Manual Key Input):
# 1. NEW - MANUAL API KEY INPUT: If the GEMINI_API_KEY is not found in the .env
#    file, the script will now prompt the user to enter it manually in the
#    console, improving usability and flexibility.
...
def main():
    ...
    fallback_config={
        "BASE_PATH": os.getcwd(), "REPORT_LABEL": "ML_Framework_V115_Playbook_Timing_FIX",
    ...
    while True:
        ...
        logger.info(f"Run {run_count} complete. Waiting 5 seconds for the next daemon loop...")
        time.sleep(5)
...
# End_To_End_Advanced_ML_Trading_Framework_PRO_V115_Playbook_Timing_FIX.py
# End_To_End_Advanced_ML_Trading_Framework_PRO_V57_High_Prob_Target
#
# V57 Update (Experiment 1):
# 1. Based on the successful V47 script.
# 2. Testing the hypothesis that a lower take-profit target will increase the win rate.
# 3. The triple-barrier labeling target is set to tp_atr=2.25 for a ~1:1.5 R:R.
...
raw_config = {
    ...
    "REPORT_LABEL": "ML_Framework_V57_High_Prob_Target",
...
# End_To_End_Advanced_ML_Trading_Framework_PRO_V56_State_And_Dynamic.py
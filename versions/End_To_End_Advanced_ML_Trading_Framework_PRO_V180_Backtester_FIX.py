# End_To_End_Advanced_ML_Trading_Framework_PRO_V180_Backtester_FIX.py
#
...
class ConfigModel(BaseModel):
    ...
    def __init__(self, **data: Any):
        ...
        # V180 FIX: Only create the run directory if a nickname has been assigned,
        # preventing the creation of temporary/empty folders.
        ...
        # These framework-level files should always point to the main Results directory
...
def run_single_instance(fallback_config: Dict, framework_history: Dict, playbook: Dict, nickname_ledger: Dict, directives: List[Dict], api_interval_seconds: int):
    ...
    # Create the final, single config object for this run. This is what creates the result folder.
    ...
    while cycle_num < len(original_retraining_dates):
        ...
        # Re-use the feature engineering object with the updated config for this cycle
        fe.config = config
    ...
    if not aggregated_trades.empty:
        ...
        # V180 FIX: Pass the correct 'framework_history' variable instead of the undefined 'framework_memory'
...
def main():
    ...
    fallback_config={
        "BASE_PATH": os.getcwd(), "REPORT_LABEL": "ML_Framework_V180_Backtester_FIX",

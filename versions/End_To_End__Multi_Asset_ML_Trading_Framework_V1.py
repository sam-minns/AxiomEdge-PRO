# End_To_End_Advanced_ML_Trading_Framework_PRO_V45_Clean_Logs
#
# V45 Update:
# 1. Suppressed the long list of "validation_0-mlogloss" lines during final model
#    training by setting `verbose=False` in the pipeline's fit parameters.
#    This makes the log output much cleaner and easier to read.
...
raw_config = {
    ...
    "REPORT_LABEL": "ML_Framework_V45_Clean_Logs",
...
# =============================================================================
class ModelTrainer:
    FEATURES = ['ATR', 'RSI', 'ADX', 'ATR_rank', 'RSI_rank', 'hour', 'day_of_week', 'adx_x_h1_trend', 'atr_x_d1_trend', 'H1_ctx_H1_Trend', 'D1_ctx_D1_Trend', 'bb_width', 'stoch_k', 'stoch_d', 'bb_width_rank', 'stoch_k_rank', 'market_regime']
    ...
    def _train_final_model(self, best_params: Dict, X: pd.DataFrame, y: pd.Series) -> Optional[Pipeline]:
        ...
        try:
            ...
            # FIX: Manually scale the validation data for the eval_set
...
# End_To_End_Advanced_ML_Trading_Framework_PRO_V43_Final_Fit_FIX.py
# End_To_End_Advanced_ML_Trading_Framework_PRO_V52_Balanced_Confidence
#
# V52 Update:
# 1. This is an experimental version to find the "sweet spot" for trade frequency and quality.
# 2. Based on the successful V47/V51 architecture.
# 3. MIN_CONFIDENCE_TO_TRADE is set to 0.48, the midpoint between the previous
#    "quality" (0.55) and "aggressive" (0.40) settings.
...
raw_config = {
    ...
    "REPORT_LABEL": "ML_Framework_V52_Balanced_Confidence",
    ...
    "MIN_CONFIDENCE_TO_TRADE": 0.48, # EXPERIMENTAL: Midpoint between 0.55 and 0.40

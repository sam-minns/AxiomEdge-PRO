# End_To_End_Advanced_ML_Trading_Framework_PRO_V122_Import_Fix
#
# V122 UPDATE (Critical Bug Fix):
# 1. FIX - NAMEERROR: Resolved a NameError crash caused by a missing 'import random'
#    statement, which affected the Exploration Mode decision logic.
#
...
#    the AI is now explicitly instructed to penalize that choice.
...
def perform_strategic_review(history: Dict) -> Dict:
    ...
    if len(recent_runs) >= 3:
        ...
        if len(set(last_three_strats)) == 1 and last_three_strats[0] is not None:
            ...
            # Check if health report for this strategy exists before accessing it
...
def main():
    ...
    fallback_config={
        "BASE_PATH": os.getcwd(), "REPORT_LABEL": "ML_Framework_V122_Import_Fix",
...
# End_To_End_Advanced_ML_Trading_Framework_PRO_V122_Import_Fix.py
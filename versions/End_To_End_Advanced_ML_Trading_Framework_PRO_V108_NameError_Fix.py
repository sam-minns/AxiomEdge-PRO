# End_To_End_Advanced_ML_Trading_Framework_PRO_V108_NameError_Fix
#
# V108 UPDATE (Critical Bug Fix):
# 1. CRITICAL FIX: Corrected a `NameError` that occurred at startup. The script was
#    passing an undefined variable `playbook` instead of the correct `strategy_playbook`
#    to the AI's pre-flight check function. This has been resolved.
#
...
# =============================================================================
# DATA LOADER, FEATURE ENGINEER, MODEL TRAINER, BACKTESTER, and PERFORMANCE ANALYZER
# are unchanged from V106. They are included in the full script below for completeness.
# =============================================================================
class DataLoader:

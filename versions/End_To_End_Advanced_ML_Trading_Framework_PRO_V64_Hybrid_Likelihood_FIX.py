# End_To_End_Advanced_ML_Trading_Framework_PRO_V64_Hybrid_Likelihood_FIX
#
# V64 Update:
# 1. Fixed KeyError in AutoBNN by using the correct, full string key for the
#    likelihood model: "normal_likelihood_logistic_noise", as found in the
#    library's source code documentation.
...
class AutoBNNTrainer:
    ...
    def _create_model(self, model_type: str, input_dim: int):
        ...
        return ab.estimators.AutoBnnMapEstimator(
            model_type,
            likelihood_model="normal_likelihood_logistic_noise",  # FIX: Use the full, correct string key
            seed=key,
            **common_config
        )

# End_To_End_Advanced_ML_Trading_Framework_PRO_V165_API_Retry_Logic.py
#
...
class PerformanceAnalyzer:
    ...
    def _get_comparison_block(self, metrics: Dict, memory: Dict, ledger: Dict, width: int) -> str:
        ...
        def get_info(source: Optional[Union[Dict, ConfigModel]], key: str) -> str:
            if not source:
                return "N/A"
            # Handle both Pydantic models (current config) and dicts (historical runs)

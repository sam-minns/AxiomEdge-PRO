# End_To_End_Advanced_ML_Trading_Framework_PRO_V178_DateOffset_FIX.py
#
...
# 1. IMPLEMENTED: AI-Managed Partial TP Switch (`USE_PARTIAL_PROFIT`).
...
def main():
    ...
    fallback_config={
        "BASE_PATH": os.getcwd(), "REPORT_LABEL": "ML_Framework_V178_DateOffset_FIX",

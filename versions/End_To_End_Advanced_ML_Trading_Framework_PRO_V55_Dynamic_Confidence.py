# End_To_End_Advanced_ML_Trading_Framework_PRO_V55_Dynamic_Confidence
#
# V55 Update:
# 1. Implemented a Dynamic Confidence Threshold in the Backtester.
# 2. The single `MIN_CONFIDENCE_TO_TRADE` setting has been removed.
# 3. The strategy now requires a lower confidence (0.45) to trade in trending markets
#    and a higher confidence (0.60) in ranging markets, making it more adaptive.
...
raw_config = {
    ...
    "REPORT_LABEL": "ML_Framework_V55_Dynamic_Confidence",
    ...
    # MIN_CONFIDENCE_TO_TRADE is now handled dynamically in the Backtester

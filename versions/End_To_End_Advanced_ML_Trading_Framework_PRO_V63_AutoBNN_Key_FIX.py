# End_To_End_Advanced_ML_Trading_Framework_PRO_V63_AutoBNN_Key_FIX
#
# V63 Update:
# 1. Fixed KeyError: 'Normal' in the AutoBNN library.
# 2. Changed the likelihood_model string from "Normal" to "normal" to match the
#    expected key in the library's internal dictionary.
...
class AutoBNNTrainer:
    ...
    def _create_model(self, model_type: str, input_dim: int):
        ...
        return ab.estimators.AutoBnnMapEstimator(
            model_type,
            likelihood_model="normal",  # FIX: Use lowercase string key
            seed=key,
            **common_config
        )

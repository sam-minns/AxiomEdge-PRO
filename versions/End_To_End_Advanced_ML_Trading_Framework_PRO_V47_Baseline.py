# End_To_End_Advanced_ML_Trading_Framework_PRO_V47_Baseline
#
# This version is the most successful iteration, serving as the new baseline.
# Key characteristics:
# 1. Features: Includes `dist_from_sma50` and `consecutive_candles`.
# 2. Labeling Target: Uses the original `tp_atr=3.0`.
# 3. Retraining Frequency: Uses the faster `60D` cycle.
# 4. Confidence Threshold: Uses the slightly more permissive `0.55`.
...
raw_config = {
    ...
    "REPORT_LABEL": "ML_Framework_V47_Baseline",

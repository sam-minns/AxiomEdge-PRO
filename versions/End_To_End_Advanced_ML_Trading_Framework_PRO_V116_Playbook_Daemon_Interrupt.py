# End_To_End_Advanced_ML_Trading_Framework_PRO_V116_Playbook_Daemon_Interrupt
#
...
#
# V115 UPDATE (Timing & Rate Limit Fix):
# 1. FIX - INTER-CYCLE DELAY: Increased the delay between walk-forward cycles to
#    5 minutes (300 seconds) to safely manage API rate limits per user request.
# 2. FIX - INTER-RUN DELAY: Decreased the delay between full script executions in
#    daemon mode to 5 seconds.
...
def main():
    ...
    fallback_config={
        "BASE_PATH": os.getcwd(), "REPORT_LABEL": "ML_Framework_V116_Playbook_Daemon_Interrupt",
    ...
    is_continuous = CONTINUOUS_RUN_HOURS > 1 or MAX_RUNS > 1
...
# End_To_End_Advanced_ML_Trading_Framework_PRO_V116_Playbook_Daemon_Interrupt.py
# End_To_End_Advanced_ML_Trading_Framework_PRO_V53_State_Features
#
# V53 Update:
# 1. Based on the successful V47 script, enhancing it with more robust features.
# 2. Replaced raw RSI/Stochastic values with "state-based" binary features
#    (e.g., is_oversold, is_trending) to help the model generalize better.
# 3. Simplified the feature set to force reliance on this new state information.
...
raw_config = {
    ...
    "REPORT_LABEL": "ML_Framework_V53_State_Features",

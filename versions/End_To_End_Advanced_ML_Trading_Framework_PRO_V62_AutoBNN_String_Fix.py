# End_To_End_Advanced_ML_Trading_Framework_PRO_V62_AutoBNN_String_Fix
#
# V62 Update:
# 1. Fixed TypeError: unhashable type in AutoBNN library.
# 2. Corrected the AutoBNNTrainer to pass the likelihood model as a string ("Normal")
#    as expected by the library, instead of passing the class instance.
...
class AutoBNNTrainer:
    ...
    def _create_model(self, model_type: str, input_dim: int):
        ...
        # FIX: Pass the likelihood model as a string name, not an object instance
        return ab.estimators.AutoBnnMapEstimator(
            model_type,
            likelihood_model="Normal", # Use string name
            seed=key,
            **common_config
        )
...
# End_To_End_Advanced_ML_Trading_Framework_PRO_V61_AutoBNN_Fix.py
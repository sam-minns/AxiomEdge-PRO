# End_To_End_Advanced_ML_Trading_Framework_PRO_V168_Robust_Frequency_FIX.py
#
# V168 UPDATE (Robust AI Frequency Handling):
# 1. FIXED - An issue where the sanitization function would incorrectly reject valid
#    Pandas frequency strings from the AI (e.g., 'W-FRI' for weekly).
# 2. IMPROVED - The sanitization function is now more robust and can correctly
#    parse day (D), week (W), and month (M) based frequencies, giving the AI
#    more flexible and reliable control over the cycle length.
#
...
class GeminiAnalyzer:
    ...
    def analyze_cycle_and_suggest_changes(self, historical_results: List[Dict], available_features: List[str], strategy_details: Dict, daily_dd_report: Dict) -> Dict:
        ...
        base_suggestions = (
            ...
            "- `RETRAINING_FREQUENCY`: How often to retrain (e.g., '60D', '7W', '1M'). Shorter means more adaptive. Use a Pandas frequency string.\n"
        )
...
def _sanitize_frequency_string(freq_str: Any, default: str = '90D') -> str:
    ...
    try:
        ...
        # If direct conversion fails, try to extract number and unit
